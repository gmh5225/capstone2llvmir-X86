...
std::string getDate(const std::tm* cTime)
{
	...
	date << (cTime->tm_year + 1900)
		 ...
		 << std::setw(2) << std::setfill('0') << (cTime->tm_mon + 1) << "-" << std::setw(2) << std::setfill('0')
		 << cTime->tm_mday;
	return date.str();
}
...
std::string getTime(const std::tm* cTime)
{
	...
	time << std::setw(2) << std::setfill('0') << cTime->tm_hour << ':' << std::setw(2) << std::setfill('0')
		 << cTime->tm_min << ':' << std::setw(2) << std::setfill('0') << cTime->tm_sec;
	return time.str();
}
