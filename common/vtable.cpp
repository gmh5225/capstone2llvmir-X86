...
VtableItem::VtableItem(const retdec::common::Address& a, const retdec::common::Address& target, bool isThumb):
	_address(a), _targetAddress(target), _isThumb(isThumb)
{}
...
Vtable::Vtable(const retdec::common::Address& a): _address(a) {}
