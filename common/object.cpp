...
Object::Object(const std::string& name, const common::Storage& storage): _name(name), _storage(storage)
{
 ...
 */
const Object* ObjectSequentialContainer::getObjectByName(const std::string& name) const
{
	for (auto& elem: *this)
	{
 ...
 * @return Pointer to object or @c nullptr if not found.
 */
const Object* ObjectSetContainer::getObjectByName(const std::string& name) const
{
	auto it = find(name);
...
GlobalVarContainer::GlobalVarContainer(): ObjectSetContainer() {}

GlobalVarContainer::GlobalVarContainer(const GlobalVarContainer& o): ObjectSetContainer(o)
{
	*this = o;
}
 ...
 */
const Object* GlobalVarContainer::getObjectByAddress(const retdec::common::Address& address) const
{
 ...
 * updated.
 */
std::pair<GlobalVarContainer::iterator, bool> GlobalVarContainer::insert(const Object& e)
{
...
std::pair<GlobalVarContainer::iterator, bool> GlobalVarContainer::insert(GlobalVarContainer::iterator, const Object& e)
{
	return insert(e);
}
