...
bool ToolInfo::isUnknown() const
{
	return !isKnown();
}
bool ToolInfo::isKnown() const
{
	return isBorland() || isGcc() || isIntel() || isOpenWatcom() || isMsvc();
}
bool ToolInfo::isBorland() const
{
	return isTool(CC_BORLAND);
}
bool ToolInfo::isGcc() const
{
	return isTool(CC_GCC);
}
bool ToolInfo::isIntel() const
{
	return isTool(CC_INTEL);
}
bool ToolInfo::isOpenWatcom() const
{
	return isTool(CC_OPEN_WATCOM);
}

bool ToolInfo::isCompiler() const
{
	return _type == T_COMPILER;
}
bool ToolInfo::isLinker() const
{
	return _type == T_LINKER;
}
bool ToolInfo::isInstaller() const
{
	return _type == T_INSTALLER;
}
bool ToolInfo::isPacker() const
{
	return _type == T_PACKER;
}
bool ToolInfo::isUnknownType() const
{
	return _type == T_UNKNOWN;
}
bool ToolInfo::isKnownType() const
{
...
{
	return (isTool(CC_VISUAL_STUDIO) || (isTool("MSVC")) || isTool("Microsoft Linker")) && isToolVersion(version);
}
...
{
	return retdec::utils::containsCaseInsensitive(_name, n) || retdec::utils::containsCaseInsensitive(_version, n);
}
...
void ToolInfo::setMajorVersion(unsigned int v)
{
	_majorVersion = v;
}
void ToolInfo::setMinorVersion(unsigned int v)
{
	_minorVersion = v;
}
void ToolInfo::setPatchVersion(unsigned int v)
{
	_patchVersion = v;
}
void ToolInfo::setAdditionalInfo(const std::string& i)
{
	_additionalInfo = i;
}
void ToolInfo::setPercentage(double p)
{
	_percentage = p;
}
void ToolInfo::setIdenticalSignificantNibbles(unsigned i)
{
	_identicalSignificantNibbles = i;
}
void ToolInfo::setTotalSignificantNibbles(unsigned i)
{
	_totalSignificantNibbles = i;
}
void ToolInfo::setIsFromHeuristics(bool h)
{
	_heuristics = h;
}
void ToolInfo::setName(const std::string& n)
{
	_name = n;
}
void ToolInfo::setType(const std::string& t)
{
	_type = t;
}

void ToolInfo::setIsUnknown()
{
	setName(CC_UNKNOWN);
}
void ToolInfo::setIsBorland()
{
	setName(CC_BORLAND);
}
void ToolInfo::setIsGcc()
{
	setName(CC_GCC);
}
void ToolInfo::setIsIntel()
{
	setName(CC_INTEL);
}
void ToolInfo::setIsOpenWatcom()
{
	setName(CC_OPEN_WATCOM);
}
void ToolInfo::setIsVisualStudio()
{
	setName(CC_VISUAL_STUDIO);
}

std::string ToolInfo::getType() const
{
	return _type;
}
std::string ToolInfo::getName() const
{
	return _name;
}
unsigned int ToolInfo::getMajorVersion() const
{
	return _majorVersion;
}
unsigned int ToolInfo::getMinorVersion() const
{
	return _minorVersion;
}
unsigned int ToolInfo::getPatchVersion() const
{
	return _patchVersion;
}
std::string ToolInfo::getAdditionalInfo() const
{
...
{
	return std::any_of(begin(), end(), [&name](const auto& t) { return t.isTool(name); });
}
...
bool ToolInfoContainer::isGcc() const
{
	return isTool("gcc");
}
bool ToolInfoContainer::isFasm() const
{
	return isTool("fasm");
}
bool ToolInfoContainer::isLlvm() const
{
	return isTool("llvm");
}
bool ToolInfoContainer::isPic32() const
{
	return isTool("xc32");
}
bool ToolInfoContainer::isMingw() const
{
	return isTool("mingw");
}
bool ToolInfoContainer::isDelphi() const
{
	return isTool("delphi");
}
bool ToolInfoContainer::isWatcom() const
{
	return isTool("watcom");
}
bool ToolInfoContainer::isIntel() const
{
	return isTool("intel");
}
bool ToolInfoContainer::isPspGcc() const
{
	return isTool("psp");
}
bool ToolInfoContainer::isBorland() const
{
	return isTool("borland");
}
bool ToolInfoContainer::isThumbCompiler() const
{
	return isTool("thumb");
}
...
{
	return std::any_of(begin(), end(), [&](const auto& t) { return t.isMsvc(version); });
}
