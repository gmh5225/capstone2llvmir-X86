...
Capstone2LlvmIrTranslator::createArch(cs_arch a, llvm::Module* m, cs_mode basic, cs_mode extra)
{
	switch (a)
	{
	case CS_ARCH_ARM: {
...
std::unique_ptr<Capstone2LlvmIrTranslator> Capstone2LlvmIrTranslator::createArm(llvm::Module* m, cs_mode extra)
{
	// return std::make_unique<Capstone2LlvmIrTranslatorArm_impl>(m, CS_MODE_ARM, extra);
	return nullptr;
}

std::unique_ptr<Capstone2LlvmIrTranslator> Capstone2LlvmIrTranslator::createThumb(llvm::Module* m, cs_mode extra)
{
	// return std::make_unique<Capstone2LlvmIrTranslatorArm_impl>(m, CS_MODE_THUMB, extra);
	return nullptr;
}

std::unique_ptr<Capstone2LlvmIrTranslator> Capstone2LlvmIrTranslator::createArm64(llvm::Module* m, cs_mode extra)
{
	// return std::make_unique<Capstone2LlvmIrTranslatorArm64_impl>(m, CS_MODE_ARM, extra);
	return nullptr;
}

std::unique_ptr<Capstone2LlvmIrTranslator> Capstone2LlvmIrTranslator::createMips32(llvm::Module* m, cs_mode extra)
{
	// return std::make_unique<Capstone2LlvmIrTranslatorMips_impl>(m, CS_MODE_MIPS32, extra);
	return nullptr;
}

std::unique_ptr<Capstone2LlvmIrTranslator> Capstone2LlvmIrTranslator::createMips64(llvm::Module* m, cs_mode extra)
{
	// return std::make_unique<Capstone2LlvmIrTranslatorMips_impl>(m, CS_MODE_MIPS64, extra);
	return nullptr;
}

std::unique_ptr<Capstone2LlvmIrTranslator> Capstone2LlvmIrTranslator::createMips3(llvm::Module* m, cs_mode extra)
{
	// return std::make_unique<Capstone2LlvmIrTranslatorMips_impl>(m, CS_MODE_MIPS3, extra);
	return nullptr;
}

std::unique_ptr<Capstone2LlvmIrTranslator> Capstone2LlvmIrTranslator::createMips32R6(llvm::Module* m, cs_mode extra)
{
	// return std::make_unique<Capstone2LlvmIrTranslatorMips_impl>(m, CS_MODE_MIPS32R6, extra);
	return nullptr;
}

std::unique_ptr<Capstone2LlvmIrTranslator> Capstone2LlvmIrTranslator::createX86_16(llvm::Module* m, cs_mode extra)
{
	return std::make_unique<Capstone2LlvmIrTranslatorX86_impl>(m, CS_MODE_16, extra);
}

std::unique_ptr<Capstone2LlvmIrTranslator> Capstone2LlvmIrTranslator::createX86_32(llvm::Module* m, cs_mode extra)
{
	return std::make_unique<Capstone2LlvmIrTranslatorX86_impl>(m, CS_MODE_32, extra);
}

std::unique_ptr<Capstone2LlvmIrTranslator> Capstone2LlvmIrTranslator::createX86_64(llvm::Module* m, cs_mode extra)
{
	return std::make_unique<Capstone2LlvmIrTranslatorX86_impl>(m, CS_MODE_64, extra);
}

std::unique_ptr<Capstone2LlvmIrTranslator> Capstone2LlvmIrTranslator::createPpc32(llvm::Module* m, cs_mode extra)
{
	// return std::make_unique<Capstone2LlvmIrTranslatorPowerpc_impl>(m, CS_MODE_32, extra);
	return nullptr;
}

std::unique_ptr<Capstone2LlvmIrTranslator> Capstone2LlvmIrTranslator::createPpc64(llvm::Module* m, cs_mode extra)
{
	// return std::make_unique<Capstone2LlvmIrTranslatorPowerpc_impl>(m, CS_MODE_64, extra);
	return nullptr;
}

std::unique_ptr<Capstone2LlvmIrTranslator> Capstone2LlvmIrTranslator::createPpcQpx(llvm::Module* m, cs_mode extra)
{
	// return std::make_unique<Capstone2LlvmIrTranslatorPowerpc_impl>(m, CS_MODE_QPX, extra);
	return nullptr;
}

std::unique_ptr<Capstone2LlvmIrTranslator> Capstone2LlvmIrTranslator::createSparc(llvm::Module* m, cs_mode extra)
{
	throw GenericError("Not implemented.");
	return nullptr;
}

std::unique_ptr<Capstone2LlvmIrTranslator> Capstone2LlvmIrTranslator::createSysz(llvm::Module* m, cs_mode extra)
{
	throw GenericError("Not implemented.");
	return nullptr;
}

std::unique_ptr<Capstone2LlvmIrTranslator> Capstone2LlvmIrTranslator::createXcore(llvm::Module* m, cs_mode extra)
{
	throw GenericError("Not implemented.");
	return nullptr;
}
